...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0AF16E40;
	constexpr int32 AppendString      = 0x044D34A0;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 GWorld            = 0x00000000;
	constexpr int32 ProcessEvent      = 0x047497B0;
...
template<typename UnderlayingClassType, int32 Size, int32 Align = 0x8>
using TActorBasedCycleFixup = CyclicDependencyFixupImpl::TCyclicClassFixup<UnderlayingClassType, Size, Align, class 
>;
