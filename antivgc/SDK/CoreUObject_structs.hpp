...
// 0x0008 (0x0008 - 0x0000)
struct FUnicodeStringLength final
{
public:
	EStringMeasurementUnits                       Units;                                             // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FUnicodeStringLength) == 0x000004, "Wrong alignment on FUnicodeStringLength");
static_assert(sizeof(FUnicodeStringLength) == 0x000008, "Wrong size on FUnicodeStringLength");
static_assert(offsetof(FUnicodeStringLength, Units) == 0x000000, "Member 'FUnicodeStringLength::Units' has a wrong offset!");
static_assert(offsetof(FUnicodeStringLength, Length) == 0x000004, "Member 'FUnicodeStringLength::Length' has a wrong offset!");
