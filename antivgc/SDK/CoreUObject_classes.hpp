...
static_assert(sizeof(UClass) == 0x000218, "Wrong size on UClass");
...
static_assert(sizeof(UDynamicClass) == 0x000298, "Wrong size on UDynamicClass");
...
{
public:
	uint8                                         Pad_218[0x1B8];                                    // 0x0218(0x01B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
