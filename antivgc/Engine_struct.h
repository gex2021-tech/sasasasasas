...
// ScriptStruct Engine.Simulated
// MotionReplicatedMove
// Size: 0xa0 (Inherited: 0x00)
...
struct FMaterialInstanceBasePropertyOverrides {
	...
	bool bOverride_WorldDecal; // 0x0a(0x01)
	bool bOverride_Fresnel; // 0x0b(0x01)
	bool bOverride_DecalDiffuseLighting; // 0x0c(0x01)
	bool bOverride_VertexFog; // 0x0d(0x01)
	bool bOverride_SortPriorityOffset; // 0x0e(0x01)
	bool bOverride_TranslucencyWritingDepth; // 0x0f(0x01)
	bool bOverride_TranslucencyDepthMode; // 0x10(0x01)
	bool bOverride_DitherOpacityMask; // 0x11(0x01)
	bool bOverride_AresEnvironmentType; // 0x12(0x01)
	bool bOverride_UseAres3PClipping; // 0x13(0x01)
	bool bOverride_UseAresProjectionMatrixIndex; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	float IndirectLightingContributionValue; // 0x18(0x04)
	enum class EMaterialLightingSource LightingSource; // 0x1c(0x01)
	enum class EMaterialLightingSourceColor LightingSourceColor; // 0x1d(0x01)
	enum class EMaterialLightingSourceDirectionality LightingSourceDirectionality; // 0x1e(0x01)
	enum class EMaterialSpecularModel SpecularModel; // 0x1f(0x01)
	enum class EMaterialCubemapMode CubemapMode; // 0x20(0x01)
	enum class EMaterialCubemapSource CubemapSource; // 0x21(0x01)
